...
<body>
    ...
    <main>
        ...
        <section class="team-section">
            <h2>Meet Our Team</h2>
            <div class="row">
                <div class="col s12 m4 team-member">
                    <h5>Savvanis Spyros</h5>
                    <p>Founder</p>
                    <div class="social-links">
                        <a href="https://www.linkedin.com/in/spyros-savvanis-7041549b/" target="_blank"><i class="material-icons">person</i></a>
                        <a href="https://github.com/savvaniss" target="_blank"><i class="material-icons">code</i></a>
                    </div>
                </div>
            </div>
        </section>
